...
public interface SettBusinessFacade {
	 ...
	 * @return settRecord
	 */
	SettRecord launchSelfHelpSettle(LaunchSettleVo launchSettleVo, BigDecimal balance, boolean isSelfHelpSettle) throws SettBizException;
	 ...
	 * @since 1.0
	 */
	public SettRecord getSettAmount(LaunchSettleVo launchSettleVo, BigDecimal balance) throws SettBizException;
	 ...
	 *            结算账户信息
	 */
	public void launchUrgentSettle(String merchantNo, String trxNo, double settAmount, UserBankAccountVo bankAccount) throws SettBizException, AccountBizException, RpcException;
